 ...
 * @author francesco
 */
public class eliminaImpiantoSportivo implements ICommand{
    ...
    ConnectToDatabase conn = new DbConnectionSingleton.Connect().connectToDb();
        ...
        public eliminaImpiantoSportivo(){}
        ...
        public static void execute() throws ParseException, SQLException 
        {
            ...
            do{    
                ...
                System.out.println("------------------------------------------");
                System.out.println("Elimina Impianto ");
                System.out.println("------------------------------------------");
                System.out.println("Inserisci nome impianto da eliminare");
                parametri[0] = sc.nextLine();
                prototypeRepo.repo.eliminaEntita(parametri);
                System.out.println("Eliminare altro impianto ? y/n");
                scelta = sc.nextLine();
            }
